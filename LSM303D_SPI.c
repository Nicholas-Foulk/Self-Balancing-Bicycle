...
void SSP_init(){
	...
	//Configure P0.15 to SPP0 CLK pin which goes to SCL on LSM303D
	...
	//Set P0.17 to MISO0 which goes to SDO on LSM303D
	LPC_PINCON -> PINSEL1 |= 1 << 3;

	//Set P0.18 to MOSI0 which goes to SDI on LSM303D
