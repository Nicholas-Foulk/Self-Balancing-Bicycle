...
//CMD_HANDLER_FUNC(motor)
//{
//    scheduler_task *compute1 = scheduler_task::getTaskPtrByName("SteeringMotorDriverSpdControl");
//    scheduler_task *compute2 = scheduler_task::getTaskPtrByName("SteeringMotorDriverSpdControl");
//
//    if(cmdParams == "manual")
//    {
//        printf("Switched to manual control");
//        compute1->
//    }
//    else if(cmdParams == "auto")
//    {
//        printf("Switched to accelerometer control");
//    }
//
//}

CMD_HANDLER_FUNC(orientation)
{
    scheduler_task *compute = scheduler_task::getTaskPtrByName("task1");
